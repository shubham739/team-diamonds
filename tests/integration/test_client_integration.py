...
from jira_client_impl.jira_impl import IssueNotFoundError, JiraClient, JiraError, get_client
...
def client() -> JiraClient:  # noqa: W0621
...
class TestGetClientAndAuthenticate:
    ...
    def test_error_message_names_every_missing_variable(
        ...
        assert "JIRA_BASE_URL" in error_text
        assert "JIRA_API_TOKEN" in error_text
