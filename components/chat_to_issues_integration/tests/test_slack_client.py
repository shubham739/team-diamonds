...
class TestSlackChatClient:
    ...
    def test_get_channels_success(self, mock_web_client: MagicMock) -> None:
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_get_channels_api_error(self, mock_web_client: MagicMock) -> None:
        """Test channel listing with API error."""
        mock_client = MagicMock()
        mock_web_client.return_value = mock_client
        mock_client.conversations_list.side_effect = SlackApiError(  # type: ignore[no-untyped-call]
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_get_channel_success(self, mock_web_client: MagicMock) -> None:
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_get_channel_not_found(self, mock_web_client: MagicMock) -> None:
        """Test channel not found error."""
        mock_client = MagicMock()
        mock_web_client.return_value = mock_client
        mock_client.conversations_info.side_effect = SlackApiError(  # type: ignore[no-untyped-call]
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_get_messages_success(self, mock_web_client: MagicMock) -> None:
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_get_messages_channel_not_found(self, mock_web_client: MagicMock) -> None:
        """Test message retrieval with channel not found."""
        mock_client = MagicMock()
        mock_web_client.return_value = mock_client
        mock_client.conversations_history.side_effect = SlackApiError(  # type: ignore[no-untyped-call]
            message="Channel not found", response={"error": "channel_not_found"},
        )
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_get_message_success(self, mock_web_client: MagicMock) -> None:
    ...
    def test_get_message_invalid_format(self) -> None:
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_get_message_not_found(self, mock_web_client: MagicMock) -> None:
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_send_message_success(self, mock_web_client: MagicMock) -> None:
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_send_message_channel_not_found(self, mock_web_client: MagicMock) -> None:
        """Test send_message with channel not found."""
        mock_client = MagicMock()
        mock_web_client.return_value = mock_client
        mock_client.chat_postMessage.side_effect = SlackApiError(  # type: ignore[no-untyped-call]
            message="Channel not found", response={"error": "channel_not_found"},
        )
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_delete_message_success(self, mock_web_client: MagicMock) -> None:
    ...
    def test_delete_message_invalid_format(self) -> None:
    ...
    @patch("chat_to_issues_integration.slack_client.WebClient")
    def test_delete_message_not_found(self, mock_web_client: MagicMock) -> None:
        """Test delete_message when message is not found."""
        mock_client = MagicMock()
        mock_web_client.return_value = mock_client
        mock_client.chat_delete.side_effect = SlackApiError(  # type: ignore[no-untyped-call]
    ...
    def test_get_client_factory_function(self) -> None:
    ...
    def test_get_client_factory_no_token(self) -> None:
